...
if (isset($_POST['Submit'])) {
    ...
    $query = mysqli_query($con, "SELECT * FROM nutrition_centers WHERE email ='$email' AND password = '$Password'");
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        if ($status == 'Accepted') {
            ...
            if ($active == 1) {
              ...
              document.location="Center_Dashboard/";
              </script>';
              ...
              >
                ...
                <div class="card mb-3">
                  <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" method="POST" action="Center_Login.php" id="login-form" >
                      <div class="col-12">
