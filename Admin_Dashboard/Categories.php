              ...
              <div class="modal-body">
                ...
                <form method="POST" action="./Categories.php" enctype="multipart/form-data">
                  ...
                  <div class="row mb-3">
                    ...
                    >
                    <div class="col-sm-8">
                      <input type="text" name="tall_range" class="form-control" />
                    </div>
                  </div>
...
while ($row1 = mysqli_fetch_array($sql1)) {
    ...
    $category_id = $row1['id'];
    $weight_range = $row1['weight_range'];
    $tall_range = $row1['tall_range'];
    $active = $row1['active'];
    ...
    ?>
                    <tr>
                      ...
                      <td><?php echo $weight_range ?></td>
                      <td><?php echo $tall_range ?></td>
