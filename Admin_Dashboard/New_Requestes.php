...
<html lang="en">
  <head>
    ...
    <title>Nutrition Centers (New Requestes) - FitAtHome</title>
  ...
  <body>
    ...
    <main id="main" class="main">
      <div class="pagetitle">
        <h1>Nutrition Centers</h1>
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
            <li class="breadcrumb-item">Nutrition Centers</li>
          </ol>
        </nav>
      </div>
      <!-- End Page Title -->
...
while ($row1 = mysqli_fetch_array($sql1)) {
    ...
    $center_id = $row1['id'];
    $center_name = $row1['name'];
    $center_email = $row1['email'];
    $center_phone = $row1['phone'];
    $status = $row1['status'];
    $active = $row1['active'];
    ...
    ?>
                    <tr>
                      <th scope="row"><?php echo $center_id ?></th>
...
<a href="./AcceptOrRejectCenter.php?center_id=<?php echo $center_id ?>&status=Accepted" class="btn btn-success me-2">Accept</a>
