...
<html lang="en">
  <head>
    ...
    <title>Users Plan - FitAtHome</title>
      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Users Plan</li>
          </ol>
        </nav>
      </div>
      <!-- End Page Title -->
            ...
            <div class="card">
              <div class="card-body">
                ...
                <table class="table datatable">
                  ...
                  <tbody>
                  <?php
$sql1 = mysqli_query($con, "SELECT * from user_plans WHERE plan_id = '$plan_id' ORDER BY id DESC");
...
while ($row1 = mysqli_fetch_array($sql1)) {
    ...
    ?>
                    <tr>
                      <th scope="row"><?php echo $user_plan_id ?></th>
                      <th scope="row"><?php echo $user_name ?></th>
                      <th scope="row"><?php echo ($is_done == 1 ? 'Done' : 'Not Done') ?></th>
